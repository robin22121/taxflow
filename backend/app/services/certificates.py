...
CATALOG: list[dict] = [
    ...
    {"code": "TAX_PAYMENT_HISTORY", "category": "HOMETAX", "title": "납부내역증명(납세사실증명)", "available": False},
    {"code": "INCOME_AMOUNT", "category": "HOMETAX", "title": "소득금액증명", "available": False},
    {"code": "VAT_BASE", "category": "HOMETAX", "title": "부가가치세 과세표준증명", "available": False},
    {"code": "VAT_EXEMPT_INCOME", "category": "HOMETAX", "title": "부가가치세 면세사업자 수입금액증명", "available": False},
    {"code": "BUSINESS_CLOSURE", "category": "HOMETAX", "title": "폐업사실증명", "available": False},
